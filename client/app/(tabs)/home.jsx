...
const HomeScreen = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`${Network.Domain}/data/history`);
        ...
        const interval = setInterval(() => {
            fetchData();
        }, 10000); // Ambil data setiap 5 detik
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <ImageBackground source={Assets.HomeBackground}>
                <View style={{ marginHorizontal: 30, paddingBottom: 40 }}>
                    ...
                    >
                        ...
                        <View>
                            <MaterialIcons name="notifications-none" size={30} style={{ color: "white" }} />
                        </View>
                    </View>
                </View>
            </ImageBackground>
            ...
            >
                <View>
                    <Text style={{ color: "black", fontWeight: "700" }}>Last Transactions</Text>
                </View>
